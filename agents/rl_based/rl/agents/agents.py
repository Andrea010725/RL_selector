...
class Agent:
    ...
    def set_random_seed(self, seed):
        ...
        if seed is not None:
            ...
            # Try to set environment seed, but handle environments without seed method
            try:
                self.env.seed(seed)
            except AttributeError:
                # Environment doesn't have seed method, skip this step
                print(f'Environment {type(self.env)} does not support seeding')
